...
const graphql_federation_factory_1 = require("@nestjs/graphql/federation/graphql-federation.factory");
const extend_util_1 = require("@nestjs/graphql/utils/extend.util");
...
let ApolloFederationDriver = class ApolloFederationDriver extends apollo_base_driver_1.ApolloBaseDriver {
    ...
    async start(options) {
        options.plugins = (0, extend_util_1.extend)(options.plugins || [], this.pluginsExplorerService.explore(options));
...
ApolloFederationDriver = (0, tslib_1.__decorate)([
    ...
    (0, tslib_1.__metadata)("design:paramtypes", [graphql_federation_factory_1.GraphQLFederationFactory,
