...
const utils_1 = require("@nestjs/graphql/utils");
...
let ApolloDriver = class ApolloDriver extends apollo_base_driver_1.ApolloBaseDriver {
    ...
    async start(apolloOptions) {
        var _a;
        apolloOptions.plugins = (0, utils_1.extend)(apolloOptions.plugins || [], this.pluginsExplorerService.explore(apolloOptions));
