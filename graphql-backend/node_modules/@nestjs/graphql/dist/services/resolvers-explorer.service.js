        ...
        if (subscriptionOptions && subscriptionOptions.filter) {
            return {
                ...
                callback: {
                    ...
                    subscribe: (...args) => (0, async_iterator_util_1.createAsyncIterator)(createSubscribeContext()(...args), (payload) => subscriptionOptions.filter.call(instanceRef, payload, ...args.slice(1))),
                },
            };
        }
        return {
...
ResolversExplorerService = ResolversExplorerService_1 = (0, tslib_1.__decorate)([
    (0, common_1.Injectable)(),
    (0, tslib_1.__param)(3, (0, common_1.Inject)(graphql_constants_1.GRAPHQL_MODULE_OPTIONS)),
